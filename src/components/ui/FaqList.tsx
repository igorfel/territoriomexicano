      ...
      {faqs.map((faq, i) => (
        <Reveal key={faq.question} delay={i * 0.05}>
          <details className="group">
            <summary className="flex cursor-pointer list-none items-center justify-between gap-6 py-6 text-left font-display text-lg text-sand transition-colors hover:text-copper md:text-xl [&::-webkit-details-marker]:hidden">
              {faq.question}
              <ChevronDown
                aria-hidden
